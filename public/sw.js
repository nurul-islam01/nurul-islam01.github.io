if (!self.define) {
  ...
  self.define = (i, c) => {
    ...
    s[n] = Promise.all(i.map((e) => d[e] || t(e))).then((e) => (c(...e), f));
  };
}
  ...
  importScripts('/fallback-382b0be8edf4f83a.js'),
    ...
    e.precacheAndRoute(
      [
        ...
        {
          url: '/_next/static/chunks/675-e6c28df1c70d9119.js',
          revision: 'e6c28df1c70d9119'
        },
        {
        ...
        {
          url: '/_next/static/chunks/main-fff4e0920562a243.js',
          revision: 'fff4e0920562a243'
        },
        {
        ...
        {
          url: '/_next/static/chunks/pages/contact-c3714b6cbcfdb3b7.js',
          revision: 'c3714b6cbcfdb3b7'
        },
        {
        ...
        {
          url: '/_next/static/css/60fa156a51214495.css',
          revision: '60fa156a51214495'
        },
        {
        ...
        {
          url: '/_next/static/xtkj8B8iDAhgyTg7sIWTn/_buildManifest.js',
          revision: '643e66a2e3ac9a6fac37f9b9b47e2448'
        },
        {
          url: '/_next/static/xtkj8B8iDAhgyTg7sIWTn/_ssgManifest.js',
        ...
        { url: '/offline', revision: 'xtkj8B8iDAhgyTg7sIWTn' },
        {
