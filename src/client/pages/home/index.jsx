                ...
                <div className='row flex-v-align'>
                  ...
                  <div className='col-sm-12 col-md-7 col-lg-7'>
                    <div className='home-text hp-left'>
                      ...
                      <h1>Nurul Islam</h1>
                      <p>
                        I am a passionate Full Stack Node.js developer, dedicated to crafting seamless and efficient web
                        solutions. With expertise in both front-end and back-end technologies, I bring creativity and
                        technical prowess to every project I undertake.
                      </p>

                      <div className='home-buttons'>
                        <Link aria-label='home button' className='btn btn-primary' to='/' target='_blank'>
                          Download CV
                        </Link>
                        <Link aria-label='btn secondary' className='btn btn-secondary' to='/contact' target='_self'>
                          Contact
                        </Link>
                      </div>
                    </div>
                ...
                <div className='info-block-w-icon'>
                  ...
                  <div className='ci-text'>
                    ...
                    <p>
                      ...
                      components. Leveraging Node.js, I create APIs that are not just functional but also scalable and
                      adaptable.
                    </p>
                  </div>
                </div>
              ...
              <div className='info-list-w-icon'>
                <div className='info-block-w-icon'>
                  ...
                  <div className='ci-text'>
                    ...
                    <p>
                      ...
                      designing optimized data structures to ensuring smooth data flow, my proficiency spans MongoDB to
                      SQL databases. I bring a keen focus on database performance, security, and scalability.
                    </p>
                  </div>
                </div>
                ...
                <div className='info-block-w-icon'>
                  ...
                  <div className='ci-text'>
                    ...
                    <p>
                      I&apos;m well-versed in the intricacies of DevOps and deployment. Leveraging tools like Docker and
                      expertise in cloud platforms such as AWS and Heroku, I streamline deployment processes, ensure
                      continuous integration, and maintain a robust development environment for efficient project
                      workflows.
                    </p>
                  </div>
                </div>
          ...
          <div className='row'>
            <div className='col-xs-12 col-sm-12'>
              ...
              <div
                ...
                <div className='testimonial-item'>
                  <div className='testimonial-content'>
                    ...
                    <div className='testimonial-text'>
                      <p>
                        A true professional in RESTful API development. Delivered a scalable solution with precision and
                        creativity. Highly recommend for any complex backend requirements.
                      </p>
                    </div>
              ...
              <div
                ...
                <div className='client-block'>
                  <a href='https://en.prothomalo.com' target='_blank' title='Prothom alo english' rel='noreferrer'>
                ...
                <div className='client-block'>
                  <a href='https://nagorik.prothomalo.com' target='_blank' title='Nagorik chinta' rel='noreferrer'>
